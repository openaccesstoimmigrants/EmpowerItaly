...
export default function Footer() {
    ...
    return (
        <section id="footer" className="pb-6 px-6 md:px-16 lg:px-22 m-auto">
            <article className="max-w-7xl m-auto">
                <div className="grid grid-cols-12 gap-6 h-full">
                    ...
                    <Link href={`${segment}` === 'documentation' ? '/' : '/documentation'} className="group col-span-12 lg:col-span-4 border-2 border-indigo-600 rounded-2xl p-4 md:p-8 lg:p-10 hover:bg-indigo-600 transition-all">
                        <p className="font-bold text-xl lg:text-3xl xl:text-4xl text-indigo-600 uppercase group-hover:text-gray-50 transition-all">
